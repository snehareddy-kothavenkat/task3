...
training_set = train_datagen.flow_from_directory( '/root/dataset/seg_train', target_size=(64, 64), batch_size=32, class_mode='categorical')
test_set = test_datagen.flow_from_directory('/root/dataset/seg_test',target_size=(64, 64),batch_size=32,class_mode='categorical')
